      ...
      <div className="p-5 flex flex-col flex-1">
        <div className="mb-4 flex-1">
          <div onClick={() => handleGetProduct(product._id)} className="block">
            <h3 className="font-semibold text-lg text-slate-900 line-clamp-1 group-hover:text-primary-600 transition-colors">
              {product.name}
            </h3>
        ...
        <div className="flex items-center justify-between mt-auto">
          ...
          <button
            className="p-3 rounded-xl bg-slate-50 text-slate-700 hover:bg-primary-600 hover:text-white transition-all cursor-pointer shadow-sm hover:shadow-primary-500/30 active:scale-95"
            onClick={(e) => {
              e.preventDefault();
              addToCart(product, 1);
            }}
